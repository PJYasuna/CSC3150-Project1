...
// 	unsigned long tls;
// 	pid_t *set_tid;
// 	size_t set_tid_sizel;
// 	int cgroup;
// 	struct cgroup *cgrp;
// 	struct css_set *cset;
// };

extern pid_t kernel_clone(struct kernel_clone_args *kargs); //y
extern int do_execve (struct filename *filename, const char __user *const __user *__argv, const char __user *const __user *__envp); //y
extern long do_wait (struct wait_opts *wo); // y
extern struct filename * getname_kernel(const char * filename); // y
